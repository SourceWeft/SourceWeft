...
pub fn web_capability(base: &Url) -> CapabilityBuilder {
    ...
    CapabilityBuilder::new("configured-web-window")
        ...
        .permission("allow-download-update")
        .permission("allow-install-update")
        .permission("allow-cancel-update-download")
        .permission("allow-cancel-update-install")
        .permission("allow-acknowledge-update-save")
        .permission("allow-set-update-preferences")
        .permission("allow-snooze-update")
