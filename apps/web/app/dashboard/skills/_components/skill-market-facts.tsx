import { BadgeCheck, Download, SquareTerminal } from "lucide-react";
...
/**
 * A skill's market facts for a detail header: verified mark, categories,
 * capability hint and install count. Renders nothing for a skill that has
 * none of them (built-ins and a workspace's own skills mostly do not).
 */
