  ...
  return {
    subscriptions: {
      individual_pro: {
        ...
        yearlyAmountCents:
          runtimeConfig.catalog.individualProYearlyAmountCents,
      ...
      team_standard: {
        ...
        yearlyAmountCents:
          runtimeConfig.catalog.teamStandardYearlyAmountCents,
...
export function validateBillingCatalog(input: {
  ...
  if (input.pricingDisplay) {
    ...
    if (
      pro &&
      (pro.monthlyPrice !== catalog.subscriptions.individual_pro.monthlyAmountCents ||
        pro.yearlyPrice !== catalog.subscriptions.individual_pro.yearlyAmountCents)
    ) {
    ...
    if (
      team &&
      (team.monthlyPrice !== catalog.subscriptions.team_standard.monthlyAmountCents ||
        team.yearlyPrice !== catalog.subscriptions.team_standard.yearlyAmountCents)
    ) {
