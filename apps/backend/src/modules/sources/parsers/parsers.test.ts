...
test("individual parsers advertise expected mime types", () => {
  assert.equal(
    textSourceParser.supportedMimeTypes.includes("text/plain"),
    true,
  );
  assert.equal(
  ...
  assert.equal(
    jsonSourceParser.supportedMimeTypes.includes("application/json"),
    true,
  );
  assert.equal(
    docxSourceParser.supportedMimeTypes.includes("application/msword"),
    true,
  );
  assert.equal(
    epubSourceParser.supportedMimeTypes.includes("application/epub+zip"),
    true,
  );
  assert.equal(
