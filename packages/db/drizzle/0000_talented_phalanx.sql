CREATE TABLE "agent_sandbox_operations" (
	...
	CONSTRAINT "agent_sandbox_operations_type_check" CHECK ("agent_sandbox_operations"."operation_type" in ('prepare', 'execute', 'collect', 'create', 'close', 'cleanup')),
	CONSTRAINT "agent_sandbox_operations_status_check" CHECK ("agent_sandbox_operations"."status" in ('proposed', 'approved', 'rejected', 'running', 'succeeded', 'failed', 'canceled')),
	CONSTRAINT "agent_sandbox_operations_duration_check" CHECK ("agent_sandbox_operations"."duration_ms" is null or "agent_sandbox_operations"."duration_ms" >= 0)
);
...
CREATE TABLE "agent_sandboxes" (
	...
	CONSTRAINT "agent_sandboxes_status_check" CHECK ("agent_sandboxes"."status" in ('creating', 'ready', 'expired', 'closed', 'error'))
);
--> statement-breakpoint
CREATE TABLE "agent_tool_trust_rules" (
	"id" text PRIMARY KEY NOT NULL,
	"team_id" text NOT NULL,
	"workspace_id" text NOT NULL,
	"user_id" text NOT NULL,
...
CREATE TABLE "artifacts" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "artifacts_artifact_type_check" CHECK ("artifacts"."artifact_type" in ('report', 'slides', 'mindmap', 'podcast', 'audio_overview', 'video_overview', 'video_presentation', 'flashcards', 'quiz', 'table', 'infographic', 'image')),
...
CREATE TABLE "chat_thread_runs" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "chat_thread_runs_status_check" CHECK ("chat_thread_runs"."status" in ('queued', 'running', 'cancel_requested', 'waiting_for_approval', 'completed', 'failed', 'cancelled')),
	CONSTRAINT "chat_thread_runs_mode_check" CHECK ("chat_thread_runs"."mode" in ('send', 'refresh', 'edit', 'resume')),
...
--> statement-breakpoint
CREATE TABLE "workspace_mcp_installs" (
	"id" text PRIMARY KEY NOT NULL,
	"team_id" text NOT NULL,
	"workspace_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "workspace_mcp_tools" (
	"id" text PRIMARY KEY NOT NULL,
	"team_id" text NOT NULL,
	"workspace_id" text NOT NULL,
	"install_id" text NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "agent_sandbox_operations" ADD CONSTRAINT "agent_sandbox_operations_sandbox_id_agent_sandboxes_id_fk" FOREIGN KEY ("sandbox_id") REFERENCES "public"."agent_sandboxes"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandbox_operations" ADD CONSTRAINT "agent_sandbox_operations_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandbox_operations" ADD CONSTRAINT "agent_sandbox_operations_thread_id_threads_id_fk" FOREIGN KEY ("thread_id") REFERENCES "public"."threads"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandbox_operations" ADD CONSTRAINT "agent_sandbox_operations_message_id_messages_id_fk" FOREIGN KEY ("message_id") REFERENCES "public"."messages"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandbox_operations" ADD CONSTRAINT "agent_sandbox_operations_workspace_team_fk" FOREIGN KEY ("workspace_id","team_id") REFERENCES "public"."workspaces"("id","organization_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandbox_operations" ADD CONSTRAINT "agent_sandbox_operations_thread_workspace_team_fk" FOREIGN KEY ("thread_id","workspace_id","team_id") REFERENCES "public"."threads"("id","workspace_id","team_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandboxes" ADD CONSTRAINT "agent_sandboxes_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandboxes" ADD CONSTRAINT "agent_sandboxes_thread_id_threads_id_fk" FOREIGN KEY ("thread_id") REFERENCES "public"."threads"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandboxes" ADD CONSTRAINT "agent_sandboxes_workspace_team_fk" FOREIGN KEY ("workspace_id","team_id") REFERENCES "public"."workspaces"("id","organization_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_sandboxes" ADD CONSTRAINT "agent_sandboxes_thread_workspace_team_fk" FOREIGN KEY ("thread_id","workspace_id","team_id") REFERENCES "public"."threads"("id","workspace_id","team_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_tool_trust_rules" ADD CONSTRAINT "agent_tool_trust_rules_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_tool_trust_rules" ADD CONSTRAINT "agent_tool_trust_rules_connector_id_source_connectors_id_fk" FOREIGN KEY ("connector_id") REFERENCES "public"."source_connectors"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_tool_trust_rules" ADD CONSTRAINT "agent_tool_trust_rules_workspace_team_fk" FOREIGN KEY ("workspace_id","team_id") REFERENCES "public"."workspaces"("id","organization_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_tool_trust_rules" ADD CONSTRAINT "agent_tool_trust_rules_connector_workspace_team_fk" FOREIGN KEY ("connector_id","workspace_id","team_id") REFERENCES "public"."source_connectors"("id","workspace_id","team_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "blog_assets" ADD CONSTRAINT "blog_assets_post_id_blog_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."blog_posts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "mcp_action_runs" ADD CONSTRAINT "mcp_action_runs_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_action_runs" ADD CONSTRAINT "mcp_action_runs_install_id_workspace_mcp_installs_id_fk" FOREIGN KEY ("install_id") REFERENCES "public"."workspace_mcp_installs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_action_runs" ADD CONSTRAINT "mcp_action_runs_tool_id_workspace_mcp_tools_id_fk" FOREIGN KEY ("tool_id") REFERENCES "public"."workspace_mcp_tools"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_action_runs" ADD CONSTRAINT "mcp_action_runs_install_workspace_team_fk" FOREIGN KEY ("install_id","workspace_id","team_id") REFERENCES "public"."workspace_mcp_installs"("id","workspace_id","team_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_tool_runs" ADD CONSTRAINT "mcp_tool_runs_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_tool_runs" ADD CONSTRAINT "mcp_tool_runs_install_id_workspace_mcp_installs_id_fk" FOREIGN KEY ("install_id") REFERENCES "public"."workspace_mcp_installs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_tool_runs" ADD CONSTRAINT "mcp_tool_runs_tool_id_workspace_mcp_tools_id_fk" FOREIGN KEY ("tool_id") REFERENCES "public"."workspace_mcp_tools"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "mcp_tool_runs" ADD CONSTRAINT "mcp_tool_runs_workspace_team_fk" FOREIGN KEY ("workspace_id","team_id") REFERENCES "public"."workspaces"("id","organization_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "workspace_mcp_credentials" ADD CONSTRAINT "workspace_mcp_credentials_install_id_workspace_mcp_installs_id_fk" FOREIGN KEY ("install_id") REFERENCES "public"."workspace_mcp_installs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_mcp_credentials" ADD CONSTRAINT "workspace_mcp_credentials_install_workspace_team_fk" FOREIGN KEY ("install_id","workspace_id","team_id") REFERENCES "public"."workspace_mcp_installs"("id","workspace_id","team_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_mcp_installs" ADD CONSTRAINT "workspace_mcp_installs_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_mcp_installs" ADD CONSTRAINT "workspace_mcp_installs_workspace_team_fk" FOREIGN KEY ("workspace_id","team_id") REFERENCES "public"."workspaces"("id","organization_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_mcp_tools" ADD CONSTRAINT "workspace_mcp_tools_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_mcp_tools" ADD CONSTRAINT "workspace_mcp_tools_install_id_workspace_mcp_installs_id_fk" FOREIGN KEY ("install_id") REFERENCES "public"."workspace_mcp_installs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workspace_mcp_tools" ADD CONSTRAINT "workspace_mcp_tools_install_workspace_team_fk" FOREIGN KEY ("install_id","workspace_id","team_id") REFERENCES "public"."workspace_mcp_installs"("id","workspace_id","team_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "agent_sandbox_operations_sandbox_created_idx" ON "agent_sandbox_operations" USING btree ("sandbox_id","created_at" desc);--> statement-breakpoint
CREATE INDEX "agent_sandbox_operations_thread_created_idx" ON "agent_sandbox_operations" USING btree ("team_id","workspace_id","thread_id","created_at" desc);--> statement-breakpoint
CREATE INDEX "agent_sandbox_operations_tool_call_idx" ON "agent_sandbox_operations" USING btree ("tool_call_id");--> statement-breakpoint
CREATE UNIQUE INDEX "agent_sandbox_operations_success_tool_call_uq" ON "agent_sandbox_operations" USING btree ("team_id","workspace_id","thread_id","operation_type","tool_call_id") WHERE "agent_sandbox_operations"."status" = 'succeeded' and "agent_sandbox_operations"."tool_call_id" is not null;--> statement-breakpoint
CREATE UNIQUE INDEX "agent_sandbox_operations_active_tool_call_uq" ON "agent_sandbox_operations" USING btree ("team_id","workspace_id","thread_id","operation_type","tool_call_id") WHERE "agent_sandbox_operations"."status" in ('running', 'succeeded') and "agent_sandbox_operations"."tool_call_id" is not null;--> statement-breakpoint
CREATE UNIQUE INDEX "agent_sandboxes_provider_sandbox_uq" ON "agent_sandboxes" USING btree ("provider","provider_sandbox_id");--> statement-breakpoint
CREATE INDEX "agent_sandboxes_thread_status_idx" ON "agent_sandboxes" USING btree ("team_id","workspace_id","thread_id","status");--> statement-breakpoint
CREATE INDEX "agent_sandboxes_expires_idx" ON "agent_sandboxes" USING btree ("status","expires_at");--> statement-breakpoint
CREATE UNIQUE INDEX "agent_sandboxes_one_active_per_thread_uq" ON "agent_sandboxes" USING btree ("provider","team_id","workspace_id","thread_id") WHERE "agent_sandboxes"."status" in ('creating', 'ready');--> statement-breakpoint
CREATE INDEX "agent_tool_trust_rules_scope_idx" ON "agent_tool_trust_rules" USING btree ("workspace_id","user_id","domain","tool_name","status");--> statement-breakpoint
CREATE INDEX "agent_tool_trust_rules_connector_idx" ON "agent_tool_trust_rules" USING btree ("connector_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "blog_assets_post_kind_hash_uq" ON "blog_assets" USING btree ("post_id","asset_kind","sha256");--> statement-breakpoint
CREATE INDEX "blog_assets_post_idx" ON "blog_assets" USING btree ("post_id");--> statement-breakpoint
CREATE UNIQUE INDEX "blog_posts_article_locale_uq" ON "blog_posts" USING btree ("article_id","locale");--> statement-breakpoint
CREATE UNIQUE INDEX "blog_posts_locale_slug_uq" ON "blog_posts" USING btree ("locale","slug");--> statement-breakpoint
CREATE INDEX "blog_posts_public_locale_published_idx" ON "blog_posts" USING btree ("locale","published_at" desc) WHERE "blog_posts"."sync_enabled" = true and "blog_posts"."status" = 'published';--> statement-breakpoint
CREATE INDEX "blog_posts_article_idx" ON "blog_posts" USING btree ("article_id");--> statement-breakpoint
...
CREATE INDEX "llm_spans_provider_started_idx" ON "llm_spans" USING btree ("provider","started_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX "mcp_action_runs_idempotency_uq" ON "mcp_action_runs" USING btree ("workspace_id","install_id","idempotency_key");--> statement-breakpoint
CREATE INDEX "mcp_action_runs_workspace_status_created_idx" ON "mcp_action_runs" USING btree ("workspace_id","status","created_at" desc);--> statement-breakpoint
CREATE INDEX "mcp_tool_runs_workspace_created_idx" ON "mcp_tool_runs" USING btree ("workspace_id","created_at" desc);--> statement-breakpoint
CREATE INDEX "mcp_tool_runs_install_created_idx" ON "mcp_tool_runs" USING btree ("install_id","created_at" desc);--> statement-breakpoint
...
CREATE UNIQUE INDEX "workspace_mcp_credentials_install_uq" ON "workspace_mcp_credentials" USING btree ("install_id");--> statement-breakpoint
CREATE UNIQUE INDEX "workspace_mcp_installs_market_uq" ON "workspace_mcp_installs" USING btree ("workspace_id","market_identifier") WHERE "workspace_mcp_installs"."market_identifier" is not null;--> statement-breakpoint
CREATE INDEX "workspace_mcp_installs_workspace_status_idx" ON "workspace_mcp_installs" USING btree ("team_id","workspace_id","status");--> statement-breakpoint
CREATE UNIQUE INDEX "workspace_mcp_tools_install_tool_uq" ON "workspace_mcp_tools" USING btree ("install_id","server_tool_name");--> statement-breakpoint
CREATE UNIQUE INDEX "workspace_mcp_tools_workspace_normalized_uq" ON "workspace_mcp_tools" USING btree ("workspace_id","normalized_tool_name");--> statement-breakpoint
CREATE INDEX "workspace_mcp_tools_install_enabled_idx" ON "workspace_mcp_tools" USING btree ("install_id","enabled");--> statement-breakpoint
