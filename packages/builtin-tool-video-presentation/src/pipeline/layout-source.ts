 ...
 *
 * This is the only executable scene-layout implementation. Browser clients
 * receive rendered media and never compile these components.
 */
/**
 * The layout primitive components exported by VIDEO_LAYOUT_PRIMITIVES_TSX.
 *
 ...
 * guidance and the `import … from "./layout-primitives"` line injected into
 * generated scenes — derives from
