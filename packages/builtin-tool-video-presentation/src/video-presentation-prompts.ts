...
export function buildVideoPresentationRuntimePromptLines(input: {
  ...
  return [
    ...
    "Never write the internal video schema, schemaVersion JSON, sceneModules array, generated project code, or planner output in the chat. The user should only see the generated artifact card and a short status.",
