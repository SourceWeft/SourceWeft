(function () {
  ...
  window.HPX["counter-explosion"] = function (el) {
    ...
    num.style.cssText =
      "position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font:900 120px system-ui,sans-serif;color:var(--text-1,#fff);pointer-events:none;text-shadow:0 4px 40px rgba(124,92,255,0.5);";
    num.textContent = "0";
    num.style.fontFamily = U.font(el);
    el.appendChild(num);
    let parts = [];
